...
{
	std::string c;
	std::cout << "If you want to work with the queue, enter 'qlib',\nwith a priority queue, enter 'qwplib',\nelse any key: ";
	std::cin >> c;
	while (c == "qlib" || c == "qwplib") 
	{
		...
		std::cout << "If you want to continue the work, please re-select queue type,\nelse any key: ";
		std::cin >> c;
	}
	system("pause");
	return 0;
